 ...
 */
public class PoweredFurnace extends BlockContainer {
    ...
    public PoweredFurnace() {
        ...
        super(Material.iron);
        this.setUnlocalizedName("Powered_Furnace");
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
        ...
        PoweredFurnaceTileEntity te = (PoweredFurnaceTileEntity)world.getTileEntity(pos);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if(stack.hasDisplayName()) {
            ...
            ((PoweredFurnaceTileEntity)worldIn.getTileEntity(pos)).setCustomName(stack.getDisplayName());
