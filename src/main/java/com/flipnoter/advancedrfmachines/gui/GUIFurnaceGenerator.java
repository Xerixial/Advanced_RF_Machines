...
public class GUIFurnaceGenerator extends GuiContainer {
    ...
    private FurnaceGeneratorTileEntity te;

    public GUIFurnaceGenerator(IInventory playerInv, FurnaceGeneratorTileEntity te) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation(advancedrfmachines.MODID + ":textures/gui/container/Furnace_Generator.png"));
        ...
        drawTexturedModalRect(guiLeft + 80, guiTop + 37 + (16 - (int)(time * 16)), 193, 16 - (int)(time * 16), 16, (int)(time * 16));
