...
public class ContainerFurnaceGenerator extends Container {
    ...
    public ContainerFurnaceGenerator(IInventory playerInv, FurnaceGeneratorTileEntity te) {

        this.te = te;

        this.addSlotToContainer(new Slot(te, 0, 62, 35));
        this.addSlotToContainer(new Slot(te, 1, 152, 17));
        this.addSlotToContainer(new Slot(te, 2, 152, 35));
        this.addSlotToContainer(new Slot(te, 3, 152, 53));
        this.addSlotToContainer(new Slot(te, 4, 8, 53));
